    ...
    <form method="post" action="{{ route('restaurant.update.config') }}">
        ...
        <ul>
            ...
            <li>
                ...
                <input type="radio" @if ($restaurantConfig['order_live_view'] == 'asc') checked @endif name="order_live_view"
                    id="order_live_view_asc" value="asc"> ASC
                <input type="radio" @if ($restaurantConfig['order_live_view'] == 'desc') checked @endif name="order_live_view"
                    id="order_live_view_desc" value="desc"> DESC
